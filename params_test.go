...
func TestWithParams(t *testing.T) {
	...
	ensure.Run("with erk.Paramable", func(ensure ensuring.E) {
		ensure.Run("setting empty params", func(ensure ensuring.E) {
			err1 := &TestParamable{}
		...
		ensure.Run("setting two params", func(ensure ensuring.E) {
			err1 := &TestParamable{}
	...
	ensure.Run("with non erk.Paramable", func(ensure ensuring.E) {
		ensure.Run("setting two params", func(ensure ensuring.E) {
			err1 := errors.New("hi")
			err2 := erk.WithParams(err1, erk.Params{"a": "hello", "b": "world"})
...
func TestParamsClone(t *testing.T) {
	...
	ensure.Run("returns empty params when params are nil", func(ensure ensuring.E) {
...
func TestParamsMarshalJSON(t *testing.T) {
	...
	ensure.Run("with no 'err' element", func(ensure ensuring.E) {
		params := erk.Params{"0": "hey", "1": "there"}
	...
	ensure.Run("with 'err' element that is not an error", func(ensure ensuring.E) {
	...
	ensure.Run("with 'err' element that is an error", func(ensure ensuring.E) {
